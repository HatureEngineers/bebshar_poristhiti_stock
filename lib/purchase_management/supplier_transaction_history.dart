...
class Transaction {
  ...
  factory Transaction.fromFirestore(DocumentSnapshot doc) {
    ...
    return Transaction(
      ...
      totalPurchase: data['totalPurchase']?.toDouble() ?? 0.0,
...
class _SupplierHistoryPageState extends State<SupplierHistoryPage> {
  ...
  Future<void> updateTransactionAndRecalculate(Transaction transaction, double newTotalPurchase, double newCashPayment) async {
  ...
  Future<void> recalculateRemainingAmounts() async {
    ...
    for (var doc in historySnapshot.docs) {
      double totalPurchase = doc['totalPurchase'];
      double cashPayment = doc['cashPayment'];
      // cumulativeRemainingAmount += (totalPurchase - cashPayment)
      cumulativeRemainingAmount = cumulativeRemainingAmount + (totalPurchase - cashPayment);
...
///////////////////////////////////////////////////////////////////
  ...
  Future<void> _editTransaction(Transaction transaction) async {
    TextEditingController totalPurchaseController = TextEditingController(text: transaction.totalPurchase.toString());
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                double newTotalPurchase = double.parse(totalPurchaseController.text);
                ...
                await FirebaseFirestore.instance
                  ...
                  'time': Timestamp.now(),
                  'reason': ' ${widget.supplierName} এর আপডেট হওয়া বিক্রয় লেনদেন\n(পুরানো বিক্রয়: $oldTotalPurchase টাকা, পুরানো পেমেন্ট: $oldCashPayment টাকা)\nনতুন বিক্রয়: $newTotalPurchase টাকা, নতুন নগদ পেমেন্ট: $newCashPayment টাকা',

                  // 'reason': ' আপডেট হওয়া ${widget.supplierName} er bikroy ট্রানজ্যাকশন (old total $oldTotalPurchase & old payment $oldCashPayment): new total $newTotalPurchase & new cash payment $newCashPayment ',
                });
              },
              ...
              onPressed: () async {
                ...
                if (confirmDelete == true) {
                  ...
                  await FirebaseFirestore.instance
                    ...
                    'amount': deleteAmount,
                    'time': Timestamp.now(),
                    'reason': ' ${widget.supplierName} এর ডিলিট হওয়া লেনদেন\n(মোট বিক্রয়: $totalAmmount টাকা, নগদ পরিশোধ: $deleteAmount টাকা)',

                    // 'reason': 'মোট বাকি: $_totalRemaining--${widget.supplierName} er ডিলিট হওয়া ট্রানজ্যাকশন: total $totalAmmount & cashpayment $deleteAmount',
                  });
          ...
          Container(
            ...
            child: Row(
              children: [
                CircleAvatar(
                  radius: 30.0,
                  backgroundImage: NetworkImage(widget.supplierImageUrl),
                ),
                ...
                IconButton(
                  ...
                  onPressed: () => _sendSMS(widget.supplierPhoneNumber),
                ),
              ],
            ),
          ),
                    ...
                    children: [
                      ...
                      Table(
                        ...
                        columnWidths: const {
                          ...
                          1: FlexColumnWidth(1), // For total Purchase
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          // Display date
                                                          Text(
                                                            '${transaction.totalPurchase - transaction.cashPayment < 0 ? 'জমা/ পরিশোধ' : 'বাকি পরিমাণ'}: ${convertToBengaliDigits((transaction.totalPurchase - transaction.cashPayment).abs())}৳',
                                                            style:
                                                            const TextStyle(
                                                                fontSize:
                                                                12),
